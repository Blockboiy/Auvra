...
export function SettingsPage() {
  ...
  return <>
    ...
    <div className="mt-6 rounded-2xl border border-line bg-white px-5 py-4 text-xs leading-5 text-muted"><strong className="text-ink">Security notice:</strong> the Railway demo uses a shared password, not individual user accounts. Wallet reads happen in the visitor's browser and are not bound to an Auvra account. Do not enable multi-user funding or wallet-linked transactions without account isolation and a security review.</div>
  </>;
}
