    ...
    <>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.2fr_.8fr]">
        ...
        <div className="space-y-6">
          ...
          <section className="card p-5"><h2 className="font-semibold text-ink">AI routing</h2><p className="mt-2 text-xs leading-5 text-muted">Requested stage models. The Models used card shows what Orbio actually served.</p><dl className="mt-4 space-y-3 text-xs"><div className="flex justify-between gap-3"><dt className="text-muted">Planning</dt><dd className="break-all text-right font-semibold text-ink">{mission.modelRoute?.planning ?? "Auto / primary"}</dd></div><div className="flex justify-between gap-3"><dt className="text-muted">Execution</dt><dd className="break-all text-right font-semibold text-ink">{mission.modelRoute?.execution ?? "Auto / primary"}</dd></div><div className="flex justify-between gap-3"><dt className="text-muted">Final synthesis</dt><dd className="break-all text-right font-semibold text-ink">{mission.modelRoute?.final ?? mission.modelRoute?.execution ?? "Auto / primary"}</dd></div></dl></section>
        </div>
      </div>
    </>
  );
